...
def tag_language(tokens: List[str]) -> List[str]:
    ...
    for i, token in enumerate(tokens):
        # Only consider capitalized tokens that are NOT at the start of a sentence
        if token[0].isupper() and i != 0 and tags[i] in ["FIL", "ENG"]:
            # Mark as OTH if it looks like a name (e.g., not a common Filipino word)
...
if __name__ == "__main__":
    ...
    example_tokens = ["Patuloy", "na", "tumatanaw", "ng", "utang", "na", "loob", "si",
    "Senador", "Ronald", "Bato", "dela", "Rosa", "kay", "Pangulong",
    "Rodrigo", "Duterte", "na", "ayon", "sa", "kanya", "ay", "siyang",
    "dahilan", "kung", "bakit", "siya", "naluklok", "sa", "kasalukuyang",
    "puwesto", "."]
    # example_tokens = ["Marami", "ang", "natawa", "sa", "latest", "vlog", "ng", "mga", "magulang", "ng", "Gonzaga", "sisters", "na", "sina", "Mommy", "Pinty", "at", "Daddy", "Bonoy", "."]

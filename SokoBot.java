...
public class SokoBot {
    ...
    // Debug info - Displays on command line (CAN REMOVE)
    ...
    System.out.println(greedyMode
            ? "\n Using Greedy Best-First Search (6+ boxes)..."
            : "\n Using A* Search (<=5 boxes)...");
    ...
    while (!open.isEmpty()) {
        ...
        if (targets.containsAll(current.boxes)) {
            System.out.println("Solution found! Explored states: " + explored); // FOR DEBUGGING - CAN REMOVE
            return current.path;
        }
        ...
        // FOR DEBUGGING - CAN REMOVE
        System.out.println("No solution found. Explored states: " + explored);

        // No solution found within the time
        return "";
    }
